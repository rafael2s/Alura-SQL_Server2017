...
UPDATE [PRODUTOS] SET [PRECO LISTA] = 5
...
UPDATE [PRODUTOS] SET [PRECO LISTA] = [PRECO LISTA] * 1.10
...
UPDATE [CLIENTES] SET [VOLUME DE COMPRA] = [VOLUME DE COMPRA] * 1.20 WHERE [ESTADO] = 'RJ'
